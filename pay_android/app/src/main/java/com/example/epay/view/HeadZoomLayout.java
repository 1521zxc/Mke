...
public class HeadZoomLayout extends ViewGroup implements NestedScrollingParent,
      ...
      switch (action) {
        ...
        case MotionEvent.ACTION_MOVE:
          ...
          if (this.mIsBeingDragged) {
            ...
            //放大头部
            this.totalZoom += overscrollTop;
            if (this.totalZoom > mTotalDragDistance){
              this.totalZoom = mTotalDragDistance;
            }
            if (this.totalZoom < 0.0F && getZoomDistance() == 0) {
            ...
            this.zoomChildView(this.totalZoom);
          }
          break;
   ...
   * 添加头部放大监听
   *
   * @param onHeadZoomListener {@link OnHeadZoomListener}
   */
