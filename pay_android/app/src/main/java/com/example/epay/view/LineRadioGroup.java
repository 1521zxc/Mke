...
/**
 * Created by liujin on 2018/4/12.
 */

public class LineRadioGroup extends LinearLayout {
            ...
            ((RadioButton) child).setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if(mOnCheckedChangeListener != null){
                        mOnCheckedChangeListener.onCheckedChanged(LineRadioGroup.this, child.getId());
                    }
                    return true;
                }
            });
                ...
                if (view instanceof RadioButton) {
                    ...
                    ((RadioButton) button).setOnTouchListener(new OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                            ...
                            if(mOnCheckedChangeListener != null){
                                mOnCheckedChangeListener.onCheckedChanged(LineRadioGroup.this, button.getId());
                            }
                            return true;
                        }
                    });
     ...
     * @see #clearCheck()
     *
     * @attr ref android.R.styleable#LineRadioGroup_checkedButton
     */
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new LineRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof LineRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(LineRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(LineRadioGroup.class.getName());
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == LineRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
