...
import com.example.epay.activity.LogoActivity;
import com.example.epay.bean.BeanNoti;
import com.example.epay.cache.CacheData;
import com.example.epay.util.NotiUtils;
...
//                cnt++;
//            }
            BeanNoti bean = gson.fromJson(data, BeanNoti.class);
            Intent intent = new Intent(this,LogoActivity.class);
            NotiUtils.put(context, bean,intent);
        }
        Log.d(TAG, "----------------------------------------------------------------------------------------------");
    }
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        CacheData.setClientId(context,clientid);
    }
    ...
    public void onReceiveCommandResult(Context context, GTCmdMessage cmdMessage) {
        ...
        if (action == PushConsts.SET_TAG_RESULT) {
            ...
            BindViewAliasResult((BindAliasCmdMessage) cmdMessage);
        } else if (action == PushConsts.UNBIND_ALIAS_RESULT) {
            unBindViewAliasResult((UnBindAliasCmdMessage) cmdMessage);
    ...
    private void BindViewAliasResult(BindAliasCmdMessage BindViewAliasCmdMessage) {
        String sn = BindViewAliasCmdMessage.getSn();
        String code = BindViewAliasCmdMessage.getCode();
        ...
        Log.d(TAG, "BindViewAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));

    }

    private void unBindViewAliasResult(UnBindAliasCmdMessage unBindViewAliasCmdMessage) {
        String sn = unBindViewAliasCmdMessage.getSn();
        String code = unBindViewAliasCmdMessage.getCode();
        ...
        Log.d(TAG, "unBindViewAlias result sn = " + sn + ", code = " + code + ", text = " + getResources().getString(text));
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Intent service = new Intent(this, MyPushIntentService.class);
    ...
    private class MyReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            intent = new Intent(context,MyPushIntentService.class);
            startService(intent);
