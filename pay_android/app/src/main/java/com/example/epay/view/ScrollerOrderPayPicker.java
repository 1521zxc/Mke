 ...
 * @author zihao
 */
public class ScrollerOrderPayPicker extends View {
	/** 控件宽度 */
	...
	/** 设置数据 */
	private ArrayList<OrderPayZheBean.OrderPayZhe> dataList = new ArrayList<OrderPayZheBean.OrderPayZhe>();
	/** 按下的坐标 */
	private int downY;
	/** 按下的时间 */
	...
	/** 默认字体 */
	private float normalFont = 30.0f;
	/** 选中的时候字体 */
	private float selectedFont = 50.0f;
	/** 单元格高度 */
	...
	public ScrollerOrderPayPicker(Context context, AttributeSet attrs,
                                  int defStyle) {
	...
	public ScrollerOrderPayPicker(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initData();
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		normalFont = attribute.getDimension(
				R.styleable.NumberPicker_normalTextSize, 30.0f);
		selectedFont = attribute.getDimension(
				R.styleable.NumberPicker_selecredTextSize, 50.0f);
	 ...
	 * @param data
	 */
	public void setData(ArrayList<OrderPayZheBean.OrderPayZhe> data) {
		this.dataList = data;
		initData();
	}
...
//					/ 2, y + move + unitHeight / 2 + textRect.height() / 2,
//					textPaint);
//			StaticLayout myStaticLayout = new StaticLayout(itemText, textPaint, canvas.getWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
//			canvas.translate(x + controlWidth / 2 -textRect.width()/2, y + move + unitHeight / 2-textRect.height() );
