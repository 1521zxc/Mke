...
public class DatePicker {
    ...
    private TextView tv_startTime,tv_endTime, tv_select, hour_text, minute_text;
    ...
    private void initView() {
        ...
        tv_startTime = (TextView) datePickerDialog.findViewById(R.id.tv_startTime);
        tv_endTime = (TextView) datePickerDialog.findViewById(R.id.tv_endTime);
        ...
        tv_startTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                type=0;
                tv_endTime.setTextColor(context.getResources().getColor(R.color.textColor_grey));
                tv_startTime.setTextColor(context.getResources().getColor(R.color.appHeaderColor));
            }
        ...
        tv_endTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                type=1;
                tv_endTime.setTextColor(context.getResources().getColor(R.color.appHeaderColor));
                tv_startTime.setTextColor(context.getResources().getColor(R.color.textColor_grey));
            }
        });
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(DateUtil.format(tv_startTime.getText().toString(),"yyyy-MM-dd"),DateUtil.format(tv_endTime.getText().toString(),"yyyy-MM-dd"));
    ...
    private void executeScroll() {
        ...
        if(type==0)
        {
            tv_startTime.setText(sdf.format(selectedCalender.getTime()));
        }else{
            tv_endTime.setText(sdf.format(selectedCalender.getTime()));
        }
    }
