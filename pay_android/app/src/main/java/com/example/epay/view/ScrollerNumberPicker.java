...
public class ScrollerNumberPicker extends View {
	...
	/** 设置数据 */
	private ArrayList<storesBean> dataList = new ArrayList<storesBean>();
	/** 按下的坐标 */
	private int downY;
	/** 按下的时间 */
	...
	private void initData() {
		...
		for (int i = 0; i < dataList.size(); i++) {
			...
			itmItemObject.id = i;
			itmItemObject.itemText = dataList.get(i).getBrandName();
	 ...
	 * @param data
	 */
	public void setData(ArrayList<storesBean> data) {
		this.dataList = data;
		initData();
	}
